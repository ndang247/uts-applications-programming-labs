...
public class StoreController extends Controller<Store> {
	...
	@FXML private Text cashTxt;
        @FXML private TableColumn<Product, String> priceClm;
	...
	@FXML private void initialize() {
		cashTxt.textProperty().bind(getStore().getCashRegister().cashProperty().asString("$%.2f"));
                ...
                productsTv.getSelectionModel().selectedItemProperty().addListener((observable, oldProduct, newProduct) -> 
                        viewBtn.setDisable(newProduct == null));
	}
